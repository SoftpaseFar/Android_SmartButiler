...
public class ThirdBezier extends View{
    ...
    public ThirdBezier(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ThirdBezier(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("☆", mFlagPointOneX, mFlagPointOneY, mPaintFlagText);
        canvas.drawText("★", mFlagPointTwoX, mFlagPointTwoY, mPaintFlagText);
